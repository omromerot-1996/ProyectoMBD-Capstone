...
Nota: los nombres reales de tus notebooks/archivos pueden variar; ajusta esta lista a tu estructura.
...
Si el mejor modelo seleccionado fuera ARIMA para el bloque de proyección a 2030, el notebook lanza una excepción (ese bloque no lo incluye por defecto).
